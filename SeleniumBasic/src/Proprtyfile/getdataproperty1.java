...
public class getdataproperty1 {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * 1. First find the location where you have stored property file
		   ...
		   4. With the help of properties reference variable call load() properties class and pass FileInputStream 
		   class reference to this method
		...
		//String fileLocation="F:\\JavaWorkspace\\CoreJavaSessions\\PropertyFiles\\TestData.properties";
						//or
		String filelocation="D:\\Workplace\\SeleniumBasic\\logindetails";
		//create an instance
		FileInputStream file=new FileInputStream(filelocation);
		//to create an instance of property
