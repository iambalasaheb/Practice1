...
public class GoogleAppwithBeforAafter extends SeleniumUtility {
	WebDriver driver;
  ...
  @Test
	public void testVtigerHomePage() {
		...
		AssertJUnit.assertEquals(actualTitle, expectedTitle, "Vtiger home page not opened or its title got changed");
	}
	@Test
	public void testReportsPage() {
		...
		String actualTitle = getPageTitle();
		AssertJUnit.assertEquals(actualTitle, expectedTitle, "Reports page not opened or its title got changed");
	}
	@AfterMethod
	public void logout() {
